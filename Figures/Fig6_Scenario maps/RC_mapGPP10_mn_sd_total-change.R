...
estSOC_rasters <- list.files("Mapping/Map_data_out/pset_RCrk_GPP10_map_data/SOC_rasters", pattern='\\.tif$')
estSOC_stack <- stack(paste0("Mapping/Map_data_out/pset_RCrk_GPP10_map_data/SOC_rasters/", estSOC_rasters))
...
estSOC_diff_range <- estSOC_diff_max - estSOC_diff_min

# Plot to see if it worked :)
plot(estSOC_diff_mean)
plot(estSOC_diff_sd)
plot(estSOC_diff_range)

estSOC_diff_range2 <- estSOC_diff_range
estSOC_diff_range2[estSOC_diff_range > 12] <- 12
plot(estSOC_diff_range2)
...
png(file="C:/github/MIMICS_HiRes/Figures/Fig6_Scenario maps/GPP10_estSOC_diff_mn_map.png", width=4000, height=6000, units="px", res=600)
...
# Setup to save plot as png
png(file="C:/github/MIMICS_HiRes/Figures/Fig6_Scenario maps/GPP10_estSOC_diff_sd_map.png", width=4000, height=6000, units="px", res=600)
