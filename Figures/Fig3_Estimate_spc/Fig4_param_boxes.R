...
MC <- readRDS("MC/Output/MC_MIMICS_best_parms_20210827_142203_.rds")

MCf <- MC

### IF you need to puul out best parameter combos from raw MC data ###
...
ggsave("Figures/Fig4_Estimate_spc/fig4_param_boxplots.png",
         plot = last_plot(),
         width = 8,
         height = 2,
         dpi = 600)
