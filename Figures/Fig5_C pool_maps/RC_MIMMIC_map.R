...
MIC <- raster("C:/local_temp/MC-PSET-MAPS/rasters/MIMMIC/estMIC_pset2.tif")

#create a color palette
pal <- colorRampPalette(c("#eaed00",
                         "#ffac37",
                          "#fd1d1d",
                          "#833ab4"))

# Setup to save plot as png
png(file="C:/github/MIMICS_HiRes/Figures/Fig5_C pool_maps/MIMMIC_map_R.png", width=4000, height=6000, units="px", res=600)
