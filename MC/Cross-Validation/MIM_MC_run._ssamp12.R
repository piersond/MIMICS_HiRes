...
# Save MC output data
##########################################
saveRDS(MC_MIMICS, paste0("MC/Cross_Validation/", "MC_MIMICS_output_ssamp12", as.character(MIM_runs), "_", format(Sys.time(), "%Y%m%d_%H%M%S_"),  ".rds"))
